...
Next, we look the relation among the traveled distance, the velocity and the acceleration. 

Simply put \ref{vtv0at} into \ref{xtx0vt} dosen't work because the result
\begin{eqnarray}
	x_t = x_0 + v_0 * t + a* t^2
\end{eqnarray}
says
