...
The first law is ``An object at rest remains at rest, and an object in motion remains in motion at constant speed and in a straight line unless acted on by an unbalanced force.''. The law also interpreted as ``The velocity or the direction of the motion of the body is changed if the force acting on the body is unbalanced.''
