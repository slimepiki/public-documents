...
\begin{enumerate}
	\item You must read these papers. But if you want to understand them completely, I recommend reading the others also.
		...
		\begin{itemize}
			\item \pname{Constraint Methods for Neural Networks and Computer Graphics}\cite{ConstrainedPlatt} Tdescribes the constraint methods for neural networks and computer graphics.
