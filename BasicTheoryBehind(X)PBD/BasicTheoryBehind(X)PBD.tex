...
\documentclass[pdflatex,sn-mathphys-num]{sn-jnl}% Basic Springer Nature Reference Style/Chemistry Reference Style
...
PBD (Position Based Dynamics) proposed at \cite{10.1016/j.jvcir.2007.01.005} is popular method because of its stability and ease of imprement. The reason of them is same, PBD computes physical simulation without using velocity inside the \gls{iteration}
...
If you start from original PBD paper\cite{10.1016/j.jvcir.2007.01.005}, you will be at lost 
