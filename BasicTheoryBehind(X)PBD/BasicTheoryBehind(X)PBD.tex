...
However, classical mechanics isn't enough to simulate complex objects or get plausible results. For example, Newtonian mechanics-based methods suffer from preserving the energies or the (angular) momenta. Unconservation causes artificial damping that creates a gap between physical accuracy and the simulation result.

Here, I explain some physical theories that often be used in soft/elastic body simulation, Lagrangian mechanics and Continuum mechanics.
\begin{figure}[h]
	\centering
	\label{physics}
