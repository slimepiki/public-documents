...
\begin{figure}[H]
	\centering
	\includegraphics[width=0.6\textwidth]{images/x_v_aGraph.png}
...
\begin{equation}
	A(t) = \sum_{i = 1}^{t/dt} v(i*dt)*dt ,
\end{equation}

and bring $dt$ to infinitesimal,

\begin{eqnarray}
	\lim_{dt \rightarrowtail 0} A(t) =\lim_{dt \rightarrowtail 0} \sum_{i=1}^{\infty}v(i*dt)*dt
\end{eqnarray}

This equation is merely formulating the above description.
